...
const Article = ({article}) => {
    ...
    return (
        <div>
            <header className="masthead" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/assets/img/post-bg.jpg)` }}>
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-10 mx-auto">
                            <div className="post-heading">
                                <h1>{article.title}</h1>
                                <h2 className="subheading">{article.content}</h2>
                                <span className="meta">Posted by
                                    Welcome to App
                                    on {new Date(article.created_at).toDateString()}</span>
                            </div>
                        </div>
                    </div>
                </div>
